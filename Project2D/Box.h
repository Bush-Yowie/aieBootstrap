...
public:
	//Box();
	Box(float elasticity, glm::vec2 position, glm::vec2 velocity, float orientation, float mass, glm::vec4 colour, float angularVelocity, float linearDrag, float angularDrag, glm::vec2 extents);
	~Box() {};
